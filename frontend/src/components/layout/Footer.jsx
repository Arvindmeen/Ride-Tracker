...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-white text-slate-500 font-sans border-t border-slate-200 mt-auto flex justify-center">
      {/* Main footer grid */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="sm:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-black text-xl text-slate-900 tracking-tight block leading-none">{APP_NAME}</span>
            ...
            <div className="grid grid-cols-3 gap-2 pt-1">
              {[{ icon: Zap, label: '< 35s Match', c: 'text-amber-400' }, { icon: DollarSign, label: '12% Fee', c: 'text-emerald-400' }, { icon: Users, label: '18 Partners', c: 'text-blue-400' }].map(({ icon: I, label, c }) => (
                <div key={label} className="bg-slate-50 rounded-xl p-2 text-center border border-slate-200">
          ...
          {/* Campus Hubs column */}
          <div>
            <h4 className="text-[11px] font-black text-slate-900 uppercase tracking-widest mb-4">Campus &amp; Regions</h4>
            <ul className="space-y-2.5 text-xs">
          ...
          {/* Safety column */}
          <div>
            <h4 className="text-[11px] font-black text-slate-900 uppercase tracking-widest mb-4">Safety &amp; Legal</h4>
            <ul className="space-y-2.5 text-xs">
